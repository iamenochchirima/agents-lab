...
`scenarioCatalog.ts` contains the small set of scenario choices currently used by the
platform Run and Compare configuration views. These are configuration choices, not yet

...
const stepsByDocument: Record<string, readonly MentalModelStep[]> = {
  "docs/architecture/agent-harness-lab.md": [
    ...
    { title: "Lab evidence and run record", files: ["src/agentlab/telemetry/", "runs/<run-id>/events.jsonl", "runs/<run-id>/metrics.json", "runs/<run-id>/result.json", "runs/<run-id>/artifacts/"] },
  ],

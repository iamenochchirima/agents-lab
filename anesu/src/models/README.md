...
token counts, and streamed content/refusal fields, while treating omitted or null usage
and text fields as valid absence. This is a bounded contract, not validation of every
...
constructs the adapter selected by configuration. `anesu chat` still chooses a

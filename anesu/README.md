...
Anesu is a standalone, compute-native agent harness built from the ground
...
`ANESU_MEMORY_EVIDENCE_RETENTION_DAYS` and
`ANESU_MEMORY_EVIDENCE_MAX_ENTRIES` when needed. Prepared deletion evidence
...
[Anesu provider acceptance playground](../development/playground/anesu-provider-acceptance/README.md).

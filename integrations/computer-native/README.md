# Computer Native integration

Computer Native is an extraction-ready computer-native agent harness currently developed
in the top-level `computer-native/` directory. It will eventually move to its own
...
- starting or contacting a Computer Native runner;
...
Computer Native is the only initial subject with **computer environments**. Its runner
...
```text
Agent Harness Lab                         Computer Native repository
-----------------                         --------------------------

...
const port = Number(process.env.COMPUTER_NATIVE_BROWSER_FIXTURE_PORT ?? 4173);
...
const fixture = page(
  "Computer Native browser fixture",
  `
    <main>
      <h1>Computer Native browser fixture</h1>
...
const dialogs = page(
  "Computer Native dialog fixture",
  `
    <main>
...
const injection = page(
  "Computer Native untrusted-content fixture",
  `
    <main>
...
const slow = page(
  "Computer Native slow-action fixture",
  `
    <main>
...
const server = createServer((request, response) => {
  ...
  if (requestUrl.pathname === "/download") {
    response.writeHead(200, {
      "content-disposition": "attachment; filename=computer-native-fixture.txt",
      "content-type": "text/plain; charset=utf-8",
    }).end("computer native local download fixture\n");
    return;
  }
...
server.listen(port, host, () => {
  console.log(`Computer Native browser fixture: http://${host}:${port}/fixture`);

...
- [context ownership](../../../anesu/src/context/README.md)
- [session ownership](../../../anesu/src/sessions/README.md)
- [profile ownership](../../../anesu/src/profiles/README.md)
...
- [Anesu follow-on queue](../anesu-follow-on-queue.md)
...
These implementations are design input, not dependencies. Anesu stays
...
Give Anesu memory that survives sessions without turning the prompt into an
...
From `anesu/`, this real local flow works with the saved development model
configuration:
...
- [x] Define typed memory records, scopes, provenance, trust, lifecycle, result, and
      error contracts in `anesu/src/memory/`.
...
- [x] Update Anesu quick-start, configuration, context, persistence, security,
...
| Local reference | Pattern adopted | Anesu decision |
| --- | --- | --- |
